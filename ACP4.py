...
background_image = pygame.transform.scale(pygame.image.load("Picture2.jpg"),
...
class Sprite(pygame.sprite.Sprite):
    ...
    def change_color(self, new_color):
        self.image.fill(pygame.Color('dodgerblue'))  # Fill with background color
...
sprite3.rect.x, sprite3.rect.y = random.randint(
    0, SCREEN_WIDTH - sprite3.rect.width), random.randint(
...
while running:
    ...
    if not won:
        ...
        if event.type == pygame.KEYDOWN and event.key == pygame.K_SPACE:
            sprite1.change_color(pygame.Color('blue'))
